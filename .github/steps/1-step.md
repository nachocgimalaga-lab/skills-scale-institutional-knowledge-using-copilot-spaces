...
1. Click **Create Space**
   ...
   <img width="50%" alt="copilot-spaces-create-space" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-create-space.png?raw=true" />
   ...
   Add a description:
      ...
      <img width="50%" alt="copilot-spaces-description" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-description.png?raw=true" />
...
1. In your newly created Copilot Space, look for the **Instructions** box and click in the **Instructions** box
   ...
   <img width="50%" alt="copilot-spaces-instructions" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-instructions.png?raw=true" />
...
1. Add the following instructions to provide context about the repository and its purpose
   ...
   <img width="50%" alt="copilot-spaces-instructions-detail" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-instructions-detail.png?raw=true" />

1. Click **Save**

### ⌨️ Activity: Add your cloned repository as a source repository to your Copilot Space

1. In your newly created Copilot Space, look for the <img width="15%" alt="add-sources-button" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/add-sources-button.png?raw=true" /> button
...
1. Verify the repository appears in your sources list
   ...
   <img width="30%" alt="add-sources" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/add-sources.png?raw=true" />
   <img width="30%" alt="add-sources-repository" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/add-sources-repository.png?raw=true" />
   <img width="30%" alt="add-sources-repository-files" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/add-sources-repository-files.png?raw=true" />
...
<img width="50%" alt="readme-issue-drafted" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/readme-issue-drafted.png?raw=true" />
...
<img width="50%" alt="readme-issue-created" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/readme-issue-created.png?raw=true" />
