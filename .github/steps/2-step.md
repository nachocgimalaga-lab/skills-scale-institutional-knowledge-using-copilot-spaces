...
2. Start a new conversation in the Copilot Space and prompt the following:
   ...
   <img width="70%" alt="copilot-spaces-conversation-summary" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-conversation-summary.png?raw=true" />
   ...
   <img width="50%" alt="copilot-spaces-conversation-summary-output" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/copilot-spaces-conversation-summary-output.png?raw=true" />
...
4. **Create the pull request**: Now send this prompt to create the pull request:
   ...
   <img width="80%" alt="repository-issue-pr-creation" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/repository-issue-pr-creation-step2.png?raw=true" />
...
6. **Monitor progress**: You should receive a notification that the Copilot coding agent is working on your pull request.
   ...
   You can track the progress of the Copilot coding agent and view details on the left side under **Agent sessions**. Click on the session to see details about the tasks being performed by the agent.
      ...
      <img width="40%" alt="agent-session-1" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/agent-sessions-1.png?raw=true" />
...
7. **Check open pull requests**: We can check pull request status from our **Copilot Space** as well.
   ...
   <img width="40%" alt="check-open-prs" src="https://github.com/nachocgimalaga-lab/skills-scale-institutional-knowledge-using-copilot-spaces/blob/main/.github/images/check-open-prs-2.png?raw=true" />
